-- Migration: Expand user_settings table with comprehensive preferences (v3 - SQLite compatible)
-- Created: 2025-11-15

-- Add missing columns to user_settings table (only constant defaults allowed in ALTER TABLE)
...
ALTER TABLE user_settings ADD COLUMN updated_at TEXT DEFAULT NULL;
