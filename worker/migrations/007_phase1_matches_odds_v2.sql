-- Migration 007 v2: Phase 1 - Rename old matches, create new comprehensive schema
-- Preserves existing picks/matches relationship

-- =====================================================
-- STEP 1: Rename old matches table to picks_matches
-- =====================================================
ALTER TABLE matches RENAME TO picks_matches;
...
-- =====================================================
-- MATCHES (Real match data from API-Football)
-- =====================================================
